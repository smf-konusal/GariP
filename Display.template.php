...
function template_single_post($message)
{
	...
	echo '
				<div class="', $message['css_class'], ' snrjpostbit" id="msg' . $message['id'] . '">
	...
	echo ' 					
						<div class="poster">
						<div class="person person-text">';
								// Show the user's avatar.
								if (!empty($modSettings['show_user_images']) && empty($options['show_no_avatars']) && !empty($message['member']['avatar']['image']))
									echo '<a href="', $message['member']['href'], '">', $message['member']['avatar']['image'], '</a>';
								
		echo '				<p>', $message['member']['link'],'</p>
							<div class="hovercard">
									<div class="hovercard-arrow">						
									</div>
									<div class="hovercard-box">									
										<div class="hovercard-body">
										', function_exists('snrjpostbittemplate') ? call_user_func('snrjpostbittemplate', $message) : snrjpostbittemplate($message), '
										</div>
									</div>
							</div>
						</div>
...
function snrjpostbittemplate($message)
{
