...
function template_bi_board_children($board)
{
	...
	if (!empty($board['children']))
	{
		...
		foreach ($board['children'] as $child)
		{
			...
			$children[] = $child['new'] ? '<li> <i class="main_icons comments"></i> <span class="strong">' . $child['link'] . '</span></li>' : '<li> <i class="main_icons comments-o"></i> <span>' . $child['link'] . '</span></li>';
		}
...
function template_info_center()
{
	...
	echo '
	<div class="card shadow mb-4" id="info_center">
		...
		<div class="card-body row" id="upshrink_stats"', empty($options['collapse_header_ic']) ? '' : ' style="display: none;"', '>';
...
function template_ic_block_recent()
{
	...
	echo '<div class="col-md-12">
			<div id="recent_posts_content" class="card mb-3 border-left-success">
...
function template_ic_block_calendar()
{
	...
	echo '<div class="col-md-12">
			<div class="card mb-1 py-2 border-left-info">
				<h4 class="subbg">
...
function template_ic_block_stats()
{
	...
	echo '<div class="col-md-6">
			<div class="card mb-1 py-2 border-left-warning">
				<h4 class="subbg">
...
function template_ic_block_online()
{
	...
	echo '<div class="col-md-6">
			<div class="card mb-1 py-2 border-left-danger">
				<h4 class="subbg">
